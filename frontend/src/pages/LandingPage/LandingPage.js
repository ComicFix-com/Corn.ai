  ...
  return (
    <div className='LandingPage'>
      <div className="left-side">
        <div className="loginform">
          <div className="container">
            ...
            <h3 className='wel-h'>Welcome back</h3>
            <p className='detail-h'>Please enter your details to sign in.</p>
            <form action="">
              <input className='inp' type="text" placeholder='    Enter your email...'/><br />
              <input className='inp' type="password" placeholder='    ************'/>
              <div className="rembr-forgt">
                <div className="ck">
                <input className='ck-box' type="checkbox" id="checkbox" name="password" />
                <label className='rem' htmlFor="checkbox">Remember me</label>
                </div>
                
                <a className='forgt' href="/">Forgot password?</a>
              </div>
              <button className='login-btn'>Login</button>
              <p className='divide'>----------------------------------     or    ------------------------------------</p>
              <button class="google-login-btn">
                <img src="google.png" alt="Google Logo" class="google-logo"/>               
                <h4 className='logn-with'> Login with Google</h4>
              </button>
      ...
      <button className="dropdown-toggle" onClick={toggleDropdown}>
        ...
        <h4 className='username'>Hefly aron</h4>
        <h5 className='email'>hfhelfly@gmail.com</h5>
        </div>
