    ...
    <div className='LandingPage'>
      ...
      <div className="right-side">
        <div className="right-container">
          ...
          <p className='para'>Experience the power of advanced AI-driven analytics and seamless CRM integration,making customer interactions smarter and more efficient than ever.</p>
